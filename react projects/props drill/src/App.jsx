...
import Card from './assets/comp/Card'
...
const App = () => {
  ...
  return(
    ...
    {jobOpenings.map(function(elem,idx){
       return <div key={idx}>
      <Card pay = {elem.pay} datePosted = {elem.datePosted} company = {elem.companyName}
       brandLogo = {elem.brandLogo} post = {elem.post} tag1 = {elem.tag1}
        tag2 ={elem.tag2}/>
        </div>
    })}
    </div>
